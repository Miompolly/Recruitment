...
$b=$rw['regdt'];
$poz=$_POST["candsvbtn"];
$t= mysql_fetch_array(mysql_query("SELECT * FROM examinfo where examcat='$a' and regdt='$b' and pozit='$poz'"));

$mx=$t['maxim']/2;

$rz= mysql_query("SELECT * FROM candidates INNER JOIN results ON candidates.candid=results.CandId where position='$poz' and examcat='Interview' ORDER BY Marks Desc");
...
<tr class="listheader">
<td colspan="7" class="h"><center>INTERVIEW EXAM RESULTS ON <FONT color='#99FFFF'><?php echo $_POST["candsvbtn"] ;?> </FONT> &nbsp;POSITION</center></td>
</tr>
...
<td class="h"><input type="checkbox" name="users[]" value="<?php echo $row["num"]; ?>" ></td>
...
<td class="h"><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ". $row["Marks"]."&nbsp;&nbsp;&nbsp;";  ?></td>
<td class="h"><?php 
...
<tr class="listheader">
<td colspan="7"><input type="button" name="update" value="Edit" onClick="setUpdateProd();" /> <input type="button" name="delete" value="Delete"  onClick="setDeleteProd();" /></td>
</tr>
</table>
