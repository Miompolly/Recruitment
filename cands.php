...
$poz=$_POST["candsvbtn"];
$rz= mysql_query("SELECT * FROM candidates where position='$poz'");
if(!$result)
{echo "fail to retrieve".mysql_error();}
?>
...
<tr class="listheader">
<td colspan="5" class="h"><center>LIST OF CANDIDATES ON <FONT color='#99FFFF'><?php echo $_POST["candsvbtn"] ;?> </FONT> &nbsp;POSITION</center></td>
</tr>
