...
$rz= mysql_query("SELECT * FROM candidates INNER JOIN results ON candidates.candid=results.CandId where position='$poz' and examcat='Written' ORDER BY Marks Desc");
...
<tr class="listheader">
<td colspan="7" class="h"><center>WRITTEN EXAM RESULTS ON <FONT color='#99FFFF'><?php echo $_POST["candsvbtn"] ;?> </FONT> &nbsp;POSITION</center></td>
</tr>
